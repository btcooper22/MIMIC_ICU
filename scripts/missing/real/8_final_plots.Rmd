...
sum(apache_additional_inunit$mort_inunit)
mean(apache_additional_inunit$mort_inunit) * 100

sum(apache_additional_30d$mort_30)
mean(apache_additional_30d$mort_30) * 100

# Missingness in each dataset
sum(is.na(apache_additional_inunit$apache_II))
mean(is.na(apache_additional_inunit$apache_II)) * 100

sum(is.na(apache_additional_30d$apache_II))
mean(is.na(apache_additional_30d$apache_II)) * 100
